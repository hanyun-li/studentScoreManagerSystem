        ...
        <ul class="nav navbar-nav navbar-right">
            <li class="dropdown menu-merge">
                <a href="#" class="dropdown-toggle fw600 p15" data-toggle="dropdown">
                    <img src="/statics/assets/img/avatars/4.jpg" class="mw30 br64">
                ...
                <ul class="dropdown-menu list-group dropdown-persist w250" role="menu">
                    <li class="list-group-item">
                        <a href="/modifyPassword/modifyStudentPassword.do?stuno=${info.stuno}" class="animated animated-short fadeInUp">
            ...
            <div class="panel heading-border">
                <div class="panel-body bg-light">
                    ...
                    <div class="section row">
                        ...
                        <div class="col-md-4">${info.stuname}</div>
                    ...
                    <div class="section row">
                        ...
                        <div class="col-md-2">所在班级</div>
                        <div class="col-md-4">${info.graclass}</div>
                    </div>
                    <div class="section row">
                        <div class="col-md-2">查询我的成绩</div>
                        <div class="col-md-4">
                            <a href="http://127.0.0.1:8080/score/queryAllScore?stuno=${info.stuno}">
                                <span style="color: greenyellow">我的成绩单</span>
                            </a>
                        </div>
