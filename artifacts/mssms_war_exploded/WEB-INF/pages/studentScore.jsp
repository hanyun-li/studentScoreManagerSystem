                ...
                <div>
                        <div class="panel-body pn">
                            <table id="message-table" class="table admin-form theme-warning tc-checkbox-1">
                                <thead>
                                <tr class="">
                                    <th colspan="6" class="text-center hidden-xs">我的的成绩单</th>
                                </tr>
                                ...
                                <tr class="">
                                    ...
                                    <th class="text-center hidden-xs">该科排名：</th>
                                </tr>
                                </thead>
                                <tbody>
                                <c:forEach items="${list}" var="cv">
                                    <tr class="message-unread">
                                        ...
                                        <td align="center">
                                            第&nbsp;<span
                                                style="color: greenyellow">${cv.studentScoreDto.rankingOfScore}</span>&nbsp;名
                                        </td>
                                    </tr>
                                </c:forEach>
                                <tr class="message-unread">
