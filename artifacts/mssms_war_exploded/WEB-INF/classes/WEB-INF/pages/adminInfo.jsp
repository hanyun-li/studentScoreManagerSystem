            ...
            <li class="dropdown menu-merge">
                ...
                <ul class="dropdown-menu list-group dropdown-persist w250" role="menu">
                    <li class="list-group-item">
                        <a href="/modifyPassword/modifyAdminPassword.do?account=${info.account}" class="animated animated-short fadeInUp">
            ...
            <div class="panel heading-border">
                <div class="panel-body bg-light">
                    ...
                    <div class="section row">
                        ...
                        <div class="col-md-4">${info.name}</div>
                        <div class="col-md-2">身份</div>
                        <div class="col-md-4">${idinfo}</div>
                    </div>
                    <div class="section row">
                        <div class="col-md-2">查看学生的成绩状况</div>
                        <div class="col-md-4">
                            <a href="http://127.0.0.1:8080/admin/queryStudentScoreStatus">
                                <span style="color: greenyellow">学生的成绩状况</span>
                            </a>
                        </div>
                        <div class="col-md-2">查询学生成绩</div>
                        <div class="col-md-4">
                            <a href="http://127.0.0.1:8080/score/goManagerQueryStudentScore">
