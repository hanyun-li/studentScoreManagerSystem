...
(function (factory) {
    if (typeof define === 'function' && define.amd) {
        // AMD. Register as a module.
        define('pnotify.buttons', ['jquery', 'statics/vendor/plugins/pnotify/pnotify'], factory);
    } else {
        // Browser globals
...
(function (factory) {
    if (typeof define === 'function' && define.amd) {
        // AMD. Register as a module.
        define('pnotify.confirm', ['jquery', 'statics/vendor/plugins/pnotify/pnotify'], factory);
    } else {
        // Browser globals
        factory(jQuery, PNotify);
    }
...
(function (factory) {
    if (typeof define === 'function' && define.amd) {
        // AMD. Register as a module.
        define('pnotify.desktop', ['jquery', 'statics/vendor/plugins/pnotify/pnotify'], factory);
    } else {
        // Browser globals
        factory(jQuery, PNotify);
    }
